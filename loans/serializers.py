...
from .models import (
    Application, Pipeline, PipelineStep, TerminalRule, PipelineRun, StepLog
)
...
class ApplicationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'applicant_name', 'amount', 'monthly_income', 
                  'declared_debts', 'country', 'loan_purpose', 'status', 'created_at']
...
class PipelineRunSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PipelineRun
        fields = ['id', 'application', 'pipeline', 'start_time', 
                  'end_time', 'final_status', 'step_logs']
